...
class UserUnitTest extends TestCase
{
    public function testUserTrue()
    {
        ...
        $this->assertTrue($user->getLastname() === 'Titi');
    ...
    public function testUserFalse(): void
    {
        ...
        $this->assertFalse($user->getPassword() === 'dark');
        $this->assertFalse($user->getFirstname() === 'Dark');
        $this->assertFalse($user->getLastname() === 'Vador');
